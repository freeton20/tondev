...
export declare function formatTokens(nanoTokens: string | number | bigint): string;
...
export declare function downloadFromGithub(terminal: Terminal, srcUrl: string, dstPath: string): Promise<void>;
export declare function downloadFromBinaries(terminal: Terminal, dstPath: string, src: string, options?: {
    executable?: boolean;
    adjustedPath?: string;
    globally?: boolean;
    version?: string;
}): Promise<void>;
export declare function run(name: string, args: string[], options: SpawnOptionsWithoutStdio, terminal: Terminal): Promise<string>;
export declare function uniqueFilePath(folderPath: string, namePattern: string): string;
...
export declare function formatTable(table: any[][], options?: {
    headerSeparator?: boolean;
    multilineSeparator?: boolean;
    multilineIndent?: string;
}): string;
export declare function parseNumber(s: string | undefined | null): number | undefined;
export declare function parseNanoTokens(s: string | undefined | null): number | undefined;
export declare function reduceBase64String(s: string | undefined): string | undefined;
...
export declare function resolveContract(filePath: string): ResolvedContractPackage;
